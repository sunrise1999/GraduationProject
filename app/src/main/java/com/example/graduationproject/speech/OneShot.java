package com.example.graduationproject.speech;
...
public class OneShot implements OnClickListener {
...
/*        super.onCreate(savedInstanceState);
        ...
        // 初始化语法文件
        mCloudGrammar = readFile(mContext, "wake_grammar_sample.abnf", "utf-8");
        mLocalGrammar = readFile(mContext, "wake.bnf", "utf-8");

    }

    private void initUI() {
        mToast = Toast.makeText(mContext, "", Toast.LENGTH_SHORT);
        mToast.setText("初始化成功!");
        mToast.show();
    ...
    GrammarListener grammarListener = new GrammarListener() {
        ...
        public void onBuildFinish(String grammarId, SpeechError error) {
            if (error == null) {
                ...
                Log.i("成功：","语法构建成功：" + grammarId);
            } else {
                Log.e("error","语法构建失败,错误码：" + error.getErrorCode() + ",请点击网址https://www.xfyun.cn/document/error-code查询解决方案");
            }
        }
    };
...
//				mIvw.setParameter(SpeechConstant.IVW_SHOT_WORD, "0");
    ...
    private WakeuperListener mWakeuperListener = new WakeuperListener() {
        ...
        public void onResult(WakeuperResult result) {
            ...
            textView.setText(resultString);
            Log.e("resulString:",resultString);
        }

        @Override
        public void onError(SpeechError error) {
            Log.e("error",error.getPlainDescription(true));
        }
