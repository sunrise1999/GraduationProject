...
package com.example.graduationproject.clusterutil.clustering.algo;
...
import com.example.graduationproject.clusterutil.projection.Bounds;
...
import com.example.graduationproject.clusterutil.quadtree.PointQuadTree;
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.example.graduationproject.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.example.graduationproject.clusterutil.clustering.algo
