 ...
 * conjunction with a {@link com.baidu.mapapi.map.BitmapDescriptorFactory}.
 * <p/>
...
public class IconGenerator {
	 ...
	 * <p/>
	 * This method is useful if a custom view has previously been set, or if text
	 ...
	 * <p/>
	 * If the view contains a {@link TextView} with the id "text", operations such
	 * as {@link #setTextAppearance} and {@link #makeIcon(String)} will operate upon
	 * that {@link TextView}.
	 */
	 ...
	 * specified <code>TextAppearance</code> resource.
	 *
	 * @param resid
	...
	public void setBackground(Drawable background) {
		...
		// setBackgroundDrawable does not call setPadding if the background has 0
		// padding.
		if (background != null) {
			Rect rect = new Rect();
